...
def main():
    ...
    print('[Test] Evaluating final Generator on test split ...')
    h_p_test = H_perfect[idx_test]
    h_i_test = H_input_pilots[idx_test]
    H_pred_test = infer_channel(generator, h_p_test, h_i_test, batch_size=args.batch_size, lower_range=lower_range, standardize=args.standardize)
