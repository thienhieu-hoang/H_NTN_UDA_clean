...
function results = syn_syn_results_(folders, folder_labels, output_folder)
    ...
    if ~isempty(avg_li_mmse)
        h_li = semilogy(snr_axis, avg_li_mmse, '--o', 'Color', [0, 0.4470, 0.7410], ...
            'LineWidth', 1.6, 'MarkerSize', 6, 'MarkerFaceColor', [0, 0.4470, 0.7410]);
    ...
    if ~isempty(avg_lmmse_mmse)
        h_lmmse = semilogy(snr_axis, avg_lmmse_mmse, '-.s', 'Color', [0.15, 0.15, 0.15], ...
            'LineWidth', 1.6, 'MarkerSize', 6, 'MarkerFaceColor', [0.15, 0.15, 0.15]);
    ...
    if ~isempty(avg_li_nmse_db)
        h_li = plot(snr_axis, avg_li_nmse_db, '--o', 'Color', [0, 0.4470, 0.7410], ...
            'LineWidth', 1.6, 'MarkerSize', 6, 'MarkerFaceColor', [0, 0.4470, 0.7410]);
        h_lines(end+1) = h_li; %#ok<AGROW>
        h_labels{end+1} = 'Avg LS+LI Benchmark'; %#ok<AGROW>
    end
    ...
    if ~isempty(avg_lmmse_nmse_db)
        h_lmmse = plot(snr_axis, avg_lmmse_nmse_db, '-.s', 'Color', [0.15, 0.15, 0.15], ...
            'LineWidth', 1.6, 'MarkerSize', 6, 'MarkerFaceColor', [0.15, 0.15, 0.15]);
        h_lines(end+1) = h_lmmse; %#ok<AGROW>
        h_labels{end+1} = 'Avg LMMSE Benchmark'; %#ok<AGROW>
    end
    ...
    if ~isempty(avg_li_ssim)
        h_li = plot(snr_axis, avg_li_ssim, '--o', 'Color', [0, 0.4470, 0.7410], ...
            'LineWidth', 1.6, 'MarkerSize', 6, 'MarkerFaceColor', [0, 0.4470, 0.7410]);
        h_lines(end+1) = h_li; %#ok<AGROW>
        h_labels{end+1} = 'Avg LS+LI Benchmark'; %#ok<AGROW>
    end
    ...
    if ~isempty(avg_lmmse_ssim)
        h_lmmse = plot(snr_axis, avg_lmmse_ssim, '-.s', 'Color', [0.15, 0.15, 0.15], ...
            'LineWidth', 1.6, 'MarkerSize', 6, 'MarkerFaceColor', [0.15, 0.15, 0.15]);
        h_lines(end+1) = h_lmmse; %#ok<AGROW>
        h_labels{end+1} = 'Avg LMMSE Benchmark'; %#ok<AGROW>
    end
    ...
    if has_ber
        ...
        if ~isempty(avg_li_ber)
            h_li = semilogy(snr_axis, avg_li_ber, '--o', 'Color', [0, 0.4470, 0.7410], ...
                'LineWidth', 1.6, 'MarkerSize', 6, 'MarkerFaceColor', [0, 0.4470, 0.7410]);
            h_lines(end+1) = h_li; %#ok<AGROW>
            h_labels{end+1} = 'Avg LS+LI Benchmark'; %#ok<AGROW>
        end
        ...
        if ~isempty(avg_lmmse_ber)
            h_lmmse = semilogy(snr_axis, avg_lmmse_ber, '-.s', 'Color', [0.15, 0.15, 0.15], ...
                'LineWidth', 1.6, 'MarkerSize', 6, 'MarkerFaceColor', [0.15, 0.15, 0.15]);
            h_lines(end+1) = h_lmmse; %#ok<AGROW>
            h_labels{end+1} = 'Avg LMMSE Benchmark'; %#ok<AGROW>
        end
