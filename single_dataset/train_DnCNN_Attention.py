...
from utils_GAN import DnCNN_ResNet_Attention                         # JMMD/helper/utils_GAN.py
...
# ----------------------------------------------------------------------------
def infer_channel(model: DnCNN_ResNet_Attention,
...
def main():
    ...
    model     = DnCNN_ResNet_Attention(n_blocks=args.n_blocks)
