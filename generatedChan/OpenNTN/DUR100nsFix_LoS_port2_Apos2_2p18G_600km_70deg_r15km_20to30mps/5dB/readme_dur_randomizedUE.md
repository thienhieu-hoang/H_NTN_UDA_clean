...
- **Pilot Density**: Sparse (88 pilots, position setting 2: subcarrier mod 6 = 2 or 3 on symbols 2 and 11)
- **Total Samples Generated**: 2048
- **Target Delay Spread Configuration**: 100.0 ns (Custom Overridden, Fixed)
- **Average RMS Delay Spread (Realized)**: 81.22 ns (Range: [3.56, 338.50] ns)
