...
| **Pilot Configuration (DM-RS)** | **5G NR DM-RS Type 2, Port 2:**<br>• **Frequency Allocation:** Subcarriers port 2 (`[2, 3, 8, 9]`) per RB (44 pilots/symbol across 11 RBs)<br>• **Time Allocation:** Mapping Type A, Pos 3 (OFDM symbols 3 and 11, 0-indexed)<br>• **Total Pilot REs:** 88 REs per slot |
