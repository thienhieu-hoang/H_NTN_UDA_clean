...
- **Pilot Symbols (0-indexed)**: [3, 11] (typeAposition=3)
- **Pilot Density**: Sparse (88 pilots, port 2: subcarrier mod 6 = 2 or 3 on symbols 3 and 11)
- **Total Samples Generated**: 2048
- **Target Delay Spread Configuration**: 100.0 ns (Custom Overridden, Fixed)
- **Average RMS Delay Spread (Realized)**: 81.42 ns (Range: [3.56, 333.17] ns)
...
- **UE Closest to Satellite (Max Elevation)**: 70.86°
- **Average Across All UEs (Mean Elevation)**: 69.52°
