# Dataset Overview: NTN TDL-A (2.18 GHz, 600 km, 70°, 30 kHz)

## General Information

- **Channel Model:** NTN TDL-A (NLOS)
- **Data Generator:** MATLAB 5G Toolbox
- **Available SNR Levels:** `-10 dB`, `-5 dB`, `0 dB`, `5 dB`, `10 dB`, `15 dB`
...
| Parameter | Value |
| :--- | :--- |
| **Environment / Scenario** | Urban Expressway |
